# The Delta Studio JavaScript Style Guide

*A mostly reasonable approach to JavaScript*

> **Note**: this guide assumes you are using [Babel](https://babeljs.io), and requires that you use [babel-preset-airbnb](https://npmjs.com/babel-preset-airbnb) or the equivalent. It also assumes you are installing shims/polyfills in your app, with [airbnb-browser-shims](https://npmjs.com/airbnb-browser-shims) or the equivalent.

> **Note**: this guide is inspired by [Airbnb](https://github.com/airbnb/javascript)
...
## Modules
  ...
  - [10.1](#modules--use-them) Always use modules (`import`/`export`) over a non-standard module system. You can always transpile to your preferred module system.
    ...
    ```javascript
    // bad
    const DeltaStyleGuide = require('./DeltaStyleGuide');
    module.exports = DeltaStyleGuide.es6;

    // ok
    import DeltaStyleGuide from './DeltaStyleGuide';
    export default DeltaStyleGuide.es6;

    // best
    import { es6 } from './DeltaStyleGuide';
    export default es6;
    ```
  ...
  - [10.2](#modules--no-wildcard) Do not use wildcard imports.
    ...
    ```javascript
    // bad
    import * as DeltaStyleGuide from './DeltaStyleGuide';
  ...
  - [10.3](#modules--no-export-from-import) And do not export directly from an import.
    ...
    // bad
    // filename es6.js
    export { es6 as default } from './DeltaStyleGuide';
...
## Naming Conventions
  ...
  - [23.8](#naming--PascalCase-singleton) Use PascalCase when you export a constructor / class / singleton / function library / bare object.
    ...
    ```javascript
    const DeltaStyleGuide = {
      es6: {
      },
    };

    export default DeltaStyleGuide;
    ```
...
7. [Let and Const](#references)
8. [Exponentiation Operator](#es2016-properties--exponentiation-operator)
...
**Other Style Guides**
  ...
  - [Google JavaScript Style Guide](https://google.github.io/styleguide/jsguide.htm
